...
export const metadata: Metadata = {
  ...
  keywords: ['valorant', 'crosshair', 'mira', 'código mira valorant', 'pro settings', 'configuración valorant', 'crosshair codes'],
  openGraph: {
    type: 'website',
    locale: 'es_ES',
    siteName: 'Crosshair',
    title: 'Crosshair - Miras de Valorant y Configuraciones Pro',
    description: 'Códigos de miras de Valorant, ajustes de profesionales y generador de crosshairs.',
    images: [{ url: '/og-image.png', width: 1200, height: 630, alt: 'Crosshair - Miras de Valorant' }]
  },
  twitter: {
    card: 'summary_large_image',
    title: 'Crosshair - Miras de Valorant',
    description: 'Códigos de miras, configuraciones pro y generador de crosshairs para Valorant.',
    images: ['/og-image.png']
  },
...
export default function RootLayout({
  ...
  return (
    <html lang='en' className={`${geistSans.variable} ${geistMono.variable} ${antonio.variable} ${bitter.variable} h-full antialiased`}>
      <head>
        {/* Google Analytics */}
        <Script src='https://www.googletagmanager.com/gtag/js?id=G-0QQM4G7CKW' strategy='afterInteractive' />
      ...
      <body className='min-h-full flex flex-col'>
        <Menu />
        <div className='px-1 w-full h-full xs:px-6 lg:px-12 2xl:px-16 flex-1'>{children}</div>
